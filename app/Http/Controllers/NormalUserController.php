...
class NormalUserController extends Controller
{
    ...
    {
        return view('page.Normal-User.profile');
    }
    ...
    {  
        ...
        return view('page.Normal-User.index',compact('UserLoc'));
    }

    public function indexUseruseregloc(Request $request)
    {   
    ...
    public function indexUserlocupda(Request $request)
    {   
        $UserLoc = UserLocation::where('user_id','=',Auth::User()->id)->count();
        if ($UserLoc > 0) {
    ...
    public function usermedInfo($medicine_id)
    {
        $medicine = Medicine::find($medicine_id);
        return view('page.Normal-User.medicine-information',compact('medicine'));
    }
    ...
    public function usermyCart()
    {
        ...
        return view('page.Normal-User.my-cart',compact('carts','count_carts','pharmacistCount','totalfee'));

    }        

    public function usermydeleteCart($id)
    {     
    ...
    public function userhistoryPurchaseInfo($historycart_id)
    {
        ...
        $totalfee = implode(',',$fee);
        return view('page.Normal-User.history-view-purchase-information',compact('cart','items','totalfee','pharmacistCount'));
    }   

    public function userhistoryForRePurchaseInfo($historycart_id)
    {
        $cart = HistoryCart::find($historycart_id);
        $items = HistoryItem::where('historycart_id','=',$historycart_id)->get();
        ...
        return view('page.Normal-User.view-history-for-repurchase-information',compact('cart','items','stock','totalfee','pharmacistCount','medicines'));
    }   


    public function userhistoryPurchasecancel($historycart_id)
    {
...
$current = Carbon::now()->toDateString();
    ...
    public function userlistMed(Request $request)
    {
