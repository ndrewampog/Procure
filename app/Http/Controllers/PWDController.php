...
class PWDController extends Controller
{
    ...
    {
        return view('page.PWD.pwd-profile');
    }
    ...
    {  
        ...
        return view('page.PWD.pwd-index',compact('UserLoc'));
    }

    public function PWDuseregloc(Request $request)
    {   
    ...
    public function PWDlocupda(Request $request)
    {   
        $UserLoc = UserLocation::where('user_id','=',Auth::User()->id)->count();
        if ($UserLoc > 0) {
    ...
    public function PWDmedInfo($medicine_id)
    {
        $medicine = Medicine::find($medicine_id);
        return view('page.PWD.pwd-medicine-information',compact('medicine'));
    }

    public function PWDaddCart(Request $request)
    {
    ...
    public function PWDmyCart()
    {
        ...
        return view('page.PWD.pwd-my-cart',compact('carts','count_carts','pharmacistCount','totalfee'));

    }        

    public function PWDmydeleteCart($id)
    {     
    ...
    public function PWDhistoryCartList()
    {
        ...
        return view('page.PWD.pwd-history-purchase-list',compact('cart_cancel_purchases','cart_order_confirmations','cart_shippeds','cart_delivereds'));
    }   

    public function PWDhistoryPurchaseInfo($historycart_id)
    {
        ...
        $totalfee = implode(',',$fee);
        return view('page.PWD.pwd-history-view-purchase-information',compact('cart','items','totalfee','pharmacistCount'));
    }   

    public function PWDhistoryForRePurchaseInfo($historycart_id)
    {
        $cart = HistoryCart::find($historycart_id);
        $items = HistoryItem::where('historycart_id','=',$historycart_id)->get();
        ...
        return view('page.PWD.pwd-view-history-for-repurchase-information',compact('cart','items','stock','totalfee','pharmacistCount','medicines'));
    }   


    public function PWDhistoryPurchasecancel($historycart_id)
    {
...
$current = Carbon::now()->toDateString();
    ...
    public function PWDlistMed(Request $request)
    {
