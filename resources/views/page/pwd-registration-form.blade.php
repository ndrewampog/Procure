...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 offset-md-2">
            <div class="card">
                <div class="card-body">
                    {!! Form::open(array('url' => '/pwd-registration-form', 'files'=>true  ))!!}
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    {!! Form::file('profile_image',['class'=>'form‐control', 'files' => true, 'id'=>'profile_image'  ]) !!}
                                </div> 
                                <div class="form-group">
                                    <img id="logo5" src="#" name="profile_image"  class="img-fluid" alt=" Your Image" />
                                </div>  
                            </div>
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label class="control-label">PWD ID No:</label>
                                     {!! Form::text('pwd_id_number',null,['class'=>'form-control','placeholder'=>'PWD ID No']) !!}
                                </div> 
                            </div>
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label class="control-label">PWD ID :</label>
                                    {!! Form::file('pwd_image_id',['class'=>'form‐control','id'=>'pwd_image_id','files' => true  ]) !!}
                                </div> 
                                <div class="form-group">
                                    <img id="logo6" src="#" name="pwd_image_id"  class="img-fluid" alt=" Your Image" />
                                </div>  
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
  ...
  function readURL(event) {
    ...
    if (input.files && input.files[0]) {
      ...
      reader.onload = function (e) {
        ...
        $('#logo6').attr('src', e.target.result);
        // $('#logo').attr('src', e.target.result);
      } 
      reader.readAsDataURL(input.files[0]);
    }
  }
  $("#pwd_image_id").change(readURL);
</script>
<script type="text/javascript">
  function readURL(event) {
    var input = event.target;
