...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 offset-md-2">
            <div class="card">
                <div class="card-body">
                    {!! Form::open(array('url' => '/senior-citizen-registration-form', 'files'=>true  ))!!}
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label class="control-label">Senior Citizen ID No:</label>
                                     {!! Form::text('senior_id_number',null,['class'=>'form-control','placeholder'=>'Senior Citizen ID No']) !!}
                                </div> 
                            </div>
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label class="control-label">Senior Citizen ID :</label>
                                    {!! Form::file('senior_image_id',['class'=>'form‐control','id'=>'senior_image_id'  ]) !!}
                                </div> 
                                <div class="form-group">
                                    <img id="logo6" src="#" name="senior_image_id"  class="img-fluid" alt=" Your Image" />
                                </div>  
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
...
<script type="text/javascript">
  ...
  $("#senior_image_id").change(readURL);
</script>
<script type="text/javascript">
  function readURL(event) {
    var input = event.target;
